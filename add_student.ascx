...
<h3>Student Registration</h3>
										...
										<form method="post" action="#">
											<div class="row uniform">
                                                ...
                                                <div class="12u$">
													  <asp:TextBox ID="TextBox6" runat="server" placeholder="Department" 
                                                          AutoPostBack="True" ReadOnly="True"></asp:TextBox>
												</div>
                                                <div class="12u$">
													  <asp:TextBox ID="TextBox7" runat="server" placeholder="Course" ReadOnly="True"></asp:TextBox>
												</div>
												<!-- Break -->
                                                <div class="12u$">
													<div class="select-wrapper">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
                                                      <asp:Label ID="Label1" runat="server" ForeColor="Red" 
                                                          Text="Email Id already exists" Visible="False"></asp:Label>
												</div>
                                                <!-- Break -->
                                                 <div class="12u$">
